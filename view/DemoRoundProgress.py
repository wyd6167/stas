...
class Progress(QDialog):
    ...
    def __init__(self, text="",parent=None):
        ...
        self.setWindowFlags(Qt.FramelessWindowHint)  # 去边框
        self.setAttribute(Qt.WA_TranslucentBackground)  # 设置窗口背景透明
        self.ProgressThread = main_controller.FindProgressThread()
        self.ProgressThread._signal.connect(self.percentUpdate)
        # self.ProgressThread._signal.connect(main_controller.Main_controller.close_progress)
        ...
        self.labell.setText(QCoreApplication.translate("Dialog", text))
        print(self.labell.width())
        self.labell.move((width-self.labell.width())/2, height/3*2)
    ...
    def connect(self, link):
        ...
        self.show()
    def percentUpdate(self, jindu):
        # self.percent += 1
        self.percent = jindu * 100
        # print(self.percent)
