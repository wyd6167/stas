...
from demo3.ui_demo3 import Ui_frmMain
...
class MyMainWindow(QMainWindow, Ui_frmMain):
    def __init__(self, parent=None):
        ...
        self.pushButtonAcount.clicked.connect(self.login_by_acount_action)  # 点击登录按钮
        self.pushButtonPhone.clicked.connect(self.login_by_phone_action)  # 点击登录按钮
