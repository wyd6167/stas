...
# Form implementation generated from reading ui file 'ui_demo4.ui'
#
...
class Ui_frmMain(object):
    def setupUi(self, frmMain):
        ...
        self.loginWin.setGeometry(QtCore.QRect(280, 130, 620, 420))
...
"}")
        ...
        self.widgetPwd.setGeometry(QtCore.QRect(150, 200, 320, 40))
        ...
        self.radioButton.setGeometry(QtCore.QRect(160, 260, 21, 31))
        self.radioButton.setText("")
        self.radioButton.setObjectName("radioButton")
        self.label = QtWidgets.QLabel(self.loginWin)
        self.label.setGeometry(QtCore.QRect(190, 260, 281, 35))
    ...
    def retranslateUi(self, frmMain):
        ...
        self.label.setText(_translate("frmMain", "<html><head/><body><p><span style=\"color:white;\">我已认真审阅并同意</span><span style=\"color:#e6a200;\">客户使用规范内容及相关协议及法律规定</span></p></body></html>"))
import demo4.res_rc
