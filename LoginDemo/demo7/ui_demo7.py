...
# Form implementation generated from reading ui file 'ui_demo7.ui'
#
...
class Ui_frmMain(object):
    def setupUi(self, frmMain):
        ...
        self.loginWin.setGeometry(QtCore.QRect(390, 150, 361, 351))
...
"}")
        ...
        self.widgetPwd.setGeometry(QtCore.QRect(20, 170, 320, 40))
        ...
        self.line.setGeometry(QtCore.QRect(20, 60, 321, 16))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.checkBox = QtWidgets.QCheckBox(self.loginWin)
        self.checkBox.setGeometry(QtCore.QRect(20, 300, 71, 16))
        self.checkBox.setObjectName("checkBox")
        self.label = QtWidgets.QLabel(self.loginWin)
        self.label.setGeometry(QtCore.QRect(23, 19, 321, 41))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
    ...
    def retranslateUi(self, frmMain):
        ...
        self.checkBox.setText(_translate("frmMain", "记住密码"))
        self.label.setText(_translate("frmMain", "动立科技.系统登录"))
import demo7.res_rc
